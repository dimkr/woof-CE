...
RUN curl https://raw.githubusercontent.com/puppylinux-woof-CE/woof-CE/testing/woof-code/rootfs-packages/ppm/usr/local/petget/categories.dat | sudo tee /usr/local/petget/categories.dat
